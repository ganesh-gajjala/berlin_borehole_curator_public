...
# import pandas as pd
# 
# parameters_df = pd.read_csv('E:\Berlin_3D-GeoModell_ganz_Parameter.dat', delimiter='\t')#, nrows=1000)
# 
# columns = ['Q1_Holozean_Neu', 'Q2_Holozean_Alt', 'Q3_Holozean_bis_Weichsel',
...
#     df = parameters_df[(parameters_df["Stratigraphie"] == stratigrpahy_id)]
#     export_df = df.copy()
# 
#     for col in columns_to_format:
#         if col in export_df.columns:
#             export_df[col] = export_df[col].map(lambda x: f"{x:.6f}")
#     
#     export_df.to_csv(f'E:/{column}.csv', index=True)
# 
#     stratigrpahy_id += 1
# =============================================================================
